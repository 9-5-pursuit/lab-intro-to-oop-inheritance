...
describe("Tamagotchi Class", () => {
  ...
  test.only("if eat method makes fullness more than 10, tamagotchi becomes sick", () => {
    fizz.full = 10;
    fizz.energy = 4;
    fizz.eat();
  ...
  test.only("Tamagotchi has medicate method", () => {
    expect(typeof fizz.medicate).toBe("function");
    expect(fizz.medicate).toBeTruthy();
  });

  test.only("Tamagotchi medicate heals sick tamagotchi", () => {
    fizz.full = 12;
    fizz.energy = 4;
    fizz.sick = true;
    fizz.medicate();
  ...
  test.only("Tamagotchi medicate for sick tamagotchi sets full to 9 and decreases energy by 3", () => {
    fizz.sick = true;
    fizz.full = 12;
    fizz.energy = 4;
    fizz.medicate();
  ...
  test.only("Tamagotchi medicate for not sick tamagotchi reduces energy by 1", () => {
    fizz.sick = false;
    fizz.energy = 4;
    fizz.medicate();
    expect(fizz.energy).toBe(3);
  ...
  test.only("Tamagotchi has play method", () => {
    expect(typeof fizz.play).toBe("function");
    expect(fizz.play).toBeTruthy();
  });

  test.only("Tamagotchi play increases mood by 2, reduces energy & full by 1", () => {
    fizz.mood = 5;
    fizz.energy = 6;
    fizz.full = 8;
    fizz.play();
  ...
  test.only("Tamagotchi won't play if it is sick", () => {
    fizz.mood = 10;
    fizz.energy = 6;
    fizz.full = 8;
    fizz.sick = true;
  ...
  test.only("Tamagotchi won't play if mood is above 9", () => {
    fizz.mood = 10;
    fizz.energy = 6;
    fizz.full = 8;
    fizz.sick = false;
  ...
  test.only("Tamagotchi won't play if energy is less than or equal to 3", () => {
    fizz.mood = 4;
    fizz.energy = 3;
    fizz.full = 3;
    fizz.play();
  ...
  test.only("Tamagotchi has sleep method", () => {
    expect(typeof fizz.sleep).toBe("function");
    expect(fizz.sleep).toBeTruthy();
  });

  test.only("Sleep method increases energy by 4 and decreases full by 3", () => {
    fizz.mood = 4;
    fizz.energy = 1;
    fizz.full = 4;
    fizz.sleep();
  ...
  test.only("Tamagotchi has timePasses method", () => {
    expect(typeof fizz.timePasses).toBe("function");
    expect(fizz.timePasses).toBeTruthy();
  });

  test.only("If tamagotchi is not sick, timePasses, mood decreases by 2, fullness and energy decrease by 1", () => {
    fizz.mood = 9;
    fizz.energy = 9;
    fizz.full = 9;
    fizz.timePasses();
  ...
  test.only("If tamagotchi is sick, timePasses, mood decreases by 3, fullness and energy decrease by 2", () => {
    fizz.sick = true;
    fizz.mood = 9;
    fizz.energy = 9;
    fizz.full = 9;
  ...
  test.only("Tamagotchi has badGuardian method", () => {
    expect(typeof fizz.badGuardian).toBe("function");
    expect(fizz.badGuardian).toBeTruthy();
  });

  test.only("If energy is less than or equal to 0, rehomed is true", () => {
    fizz.energy = 0;
    fizz.mood = 9;
    fizz.full = 9;
    fizz.badGuardian();
  ...
  test.only("If mood is less than or equal to 0, rehomed is true", () => {
    fizz.mood = 0;
    fizz.energy = 9;
    fizz.full = 9;
    fizz.badGuardian();
  ...
  test.only("If full is less than or equal to 0, rehomed is true", () => {
    fizz.mood = 9;
    fizz.energy = 9;
    fizz.full = 0;
    fizz.badGuardian();
